...
public class AdminController {
	...
	// Procedimiento que verifica las credenciales y permite al administrador
	// entrar
	...
	private void ingresarAction() {
		...
		if (datosValidos(usuarioAdmin, contraseniaAdmin)) {
			...
			if (documentoValido) {
				...
				mostrarMensaje("Notificacion Inicio sesion", "Usuario no existe",
						"Los datos ingresados no corresponde a un usuario valido", AlertType.INFORMATION);

			}
		} else {
			mostrarMensaje("Notificacion Inicio sesion", "Datos Incompletos",
	...
	// Metodo que verifica que los datos ingresados no sean nulos
	...
	// Procedimiento que muestra los mensajes
